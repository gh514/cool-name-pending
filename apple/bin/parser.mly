...
%token EQUAL LT GT LTE GTE UNEQUAL MEMBER ADJACENT DIAGADJACENT
...
%left ABS DIFF
%left ADD SUB AND MEMBER ADJACENT DIAGADJACENT
...
expr:
    ...
    | simple_expr DIAGADJACENT simple_expr  {Past.SpecOp(location(), $1, Past.DiagAdjacent, $3)}
